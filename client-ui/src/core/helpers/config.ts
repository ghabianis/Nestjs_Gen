 ...
 * @param {string} icon Current page Toolbar button icon
 */
 ...
 * @param {string} pageTitle Current page title
 * @param {string} pageSubTitle Current page subtitle
 * @param {string} image Current page Toolbar image
 */
export const setCurrentPageToolbar = (
  pageTitle: string,
  pageSubTitle?: string,
  image?: string,
): void => {
  configStore.setToolbars({
    title: pageTitle,
...
/**
 * Get the videoSubheader display
 * @returns {boolean}
 */
 export const videoSubheaderDisplay = computed(() =>
 configStore.layoutConfig("videoToolbar.display", "videoToolbar.display")
);
