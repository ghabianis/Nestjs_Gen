<template>
  ...
  <div class="page d-flex flex-row flex-column-fluid p-abs w-100">
    ...
    <div id="kt_wrapper" class="d-flex flex-column flex-row-fluid wrapper ">
      ...
      <div
        id="kt_content"
        class="content d-flex flex-column flex-column-fluid content__container"
      >
        <!-- begin:: Content Head -->
        <KTToolbar
...
import KTToolbar from "@/components/layouts/mainLayout/toolbar/Toolbar_2.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const { pageTitle, pageSubTitle, image } = storeToRefs(useConfigStore());
